...
CREATE TABLE brand_category_mapping (
  ...
  modified_date TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (id),
  UNIQUE INDEX udx_brand_category_mapping (brand_code,category_code)
)ENGINE=InnoDB auto_increment=1 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE goods (
  ...
  modified_date TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (id),
  UNIQUE INDEX udx_sku_brand_sku (brand_code,goods_code)
)ENGINE=InnoDB auto_increment=1 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE goods_category_mapping (
  ...
  modified_date TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (id),
  UNIQUE INDEX udx_goods_category_mapping_goods_categor (goods_code,category_code)
)ENGINE=InnoDB auto_increment=1 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE sku (
  ...
  UNIQUE INDEX idx_sku_brand_sku (brand_code,sku_code)
)ENGINE=InnoDB auto_increment=1 DEFAULT CHARSET=utf8mb4;
